<section id="layanan" class="layanan">
	<div class="row">
		...
		<div class="col-3 p-1">
			<a href="<?=base_url('home/menu_lainnya')?>" class=" text-decoration-none">
			<div class="menu-item rounded shadow-sm p-0">
				<img class="d-block m-auto mb-2 mt-1" src="<?=base_url('assets_mobile/img/ic/lainnya.png')?>" height="40">
				<p class="text-center mt-3">Lainnya</p>
			</div>
			</a>
		</div>
	</div>
